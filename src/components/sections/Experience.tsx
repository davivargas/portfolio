...
const experiences = [
  ...
  },
  {
    ...
    details: [
      ...
      "Wrote 58 test suites (Vitest, Jest, Testcontainers against real PostgreSQL) and nine operator runbooks so Zip's team could run the platform after the internship; authored 500 of its 800 commits.",
